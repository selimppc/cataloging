        ...
        if ($data = $this->getRequest()->getPost()) {
            ...
            if(isset($_FILES['editor_filename']['name']) && $_FILES['editor_filename']['name'] != '') {
                try {
                    ...
                    $path = $imageDir . DS ;
                    $path2 = $imageDir.'/thumbs'. DS ;
                    $result = $uploader->save($path, $_FILES['editor_filename']['name'] );
                    $result2 = $uploader->save($path2, $_FILES['editor_filename']['name'] );
                    ...
                    $data['thumb_editor_filename'] = "editorimages/thumbs".DS.$result['file'];

                    //print_r($data['thumb_editor_filename']);exit;
