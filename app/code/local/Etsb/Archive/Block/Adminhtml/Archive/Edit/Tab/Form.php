...
class Etsb_Archive_Block_Adminhtml_Archive_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm()
    {
        $form = new Varien_Data_Form();
        $this->setForm($form);
        $fieldset = $form->addFieldset('archive_form', array('legend'=>Mage::helper('archive')->__('Banner information')));
        ...
        if ( Mage::getSingleton('adminhtml/session')->getArchiveData() )
        {
            $data = Mage::getSingleton('adminhtml/session')->getArchiveData();
            Mage::getSingleton('adminhtml/session')->setArchiveData(null);
        } elseif ( Mage::registry('archive_data') ) {
            $data = Mage::registry('archive_data')->getData();
        }
