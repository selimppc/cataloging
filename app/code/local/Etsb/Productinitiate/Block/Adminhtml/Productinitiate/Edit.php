...
class Etsb_Productinitiate_Block_Adminhtml_Productinitiate_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    public function getHeaderText()
    {
        ...
        return Mage::helper('productinitiate')->__("Edit Item '%s'", $this->htmlEscape(Mage::registry('productinitiate_data')->getTitle()));
        } else {
        return Mage::helper('productinitiate')->__('Add Item');
        }
    }
}