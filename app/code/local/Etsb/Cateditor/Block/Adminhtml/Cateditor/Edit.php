...
class Etsb_Cateditor_Block_Adminhtml_Cateditor_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    public function getHeaderText()
    {
        if( Mage::registry('cateditor_data') && Mage::registry('cateditor_data')->getId() ) {
            return Mage::helper('cateditor')->__("Edit banner '%s'", $this->htmlEscape(Mage::registry('cateditor_data')->getTitle()));
        } else {
